            ...
            <div className="p-4 bg-base-200 rounded-xl">
              ...
              <div className="form-control mb-4">
                ...
                <div className="flex bg-base-300 p-2 rounded-lg">
                  <input type="number"
                    className="input input-ghost focus:outline-none h-[2.5rem] min-h-[2.5rem] px-4 w-full" value={inputAmount} onChange={(e) => setInputAmount(e.target.value)} placeholder="Enter the amount to send with increment" step="0.01" min="0" />
                </div>
                <div className="flex justify-center gap-4 mt-4">
                  ...
                  >
                    {inputAmount && parseFloat(inputAmount) > 0 ? `Increment + Send ${inputAmount} STRK` : "Increment"}
                  </button>
                  <button className="btn btn-outline btn-lg" onClick={() => console.log("Reset clicked")}
                  >
